...
public enum TopLevelRuleType: String, CaseIterable, ExpressibleByArgument {
    ...
    var isTestRule: Bool {
        switch self {
        case .iosUnitTest,.iosUiTest, .watchosUnitTest, .watchosUiTest, .macosUnitTest, .macosUiTest, .tvosUnitTest, .tvosUiTest, .visionosUnitTest, .visionosUiTest: return true
