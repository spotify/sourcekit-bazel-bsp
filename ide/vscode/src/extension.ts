...
async function onProcessedGraphFileChanged() {
...
export async function activate(context: vscode.ExtensionContext) {
    ...
    testController = new TestController(context, buildTaskProvider, lspTestDiscovery, outputChannel, configuration.enableTestDiscovery);
